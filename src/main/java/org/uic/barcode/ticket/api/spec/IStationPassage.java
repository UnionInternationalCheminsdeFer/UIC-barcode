...
public interface IStationPassage extends IDocumentData {
     ...
     */
    public default Collection<String> getStations() {
        return getStationsInt().stream().map(CharSequence::toString).collect(Collectors.toList());
    }
     ...
     */
    public default Collection<String> getAreaCodes() {
        return getAreaCodesInt().stream().map(CharSequence::toString).collect(Collectors.toList());
    }
