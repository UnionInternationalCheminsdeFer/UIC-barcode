...
public interface IZone extends IRegionalValidity {
     ...
     * @return the carrier
     */
    public default String getCarrier() {
        CharSequence v = getCarrierInt();
        if (v == null) {
            return null;
        }
        return v.toString();
     ...
     */
    public default String getEntryStation() {
        CharSequence v = getEntryStationInt();
        if (v == null) {
            return null;
        }
        return v.toString();
     ...
     */
    public default String getTerminatingStation() {
        CharSequence v = getTerminatingStationInt();
        if (v == null) {
            return null;
        }
        return v.toString();
