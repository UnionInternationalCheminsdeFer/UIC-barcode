...
public class SimplePass extends SimpleDocumentData implements IPass {
     ...
     * The countries.
     */
    protected Collection<Integer> countries = new LinkedHashSet<>();
    ...
    /* (nicht-Javadoc)
     * @see org.uic.ticket.api.spec.IPass#addIncludedCarrierMustString(java.lang.Integer)
     */
    ...
    /* (nicht-Javadoc)
     * @see org.uic.ticket.api.spec.IPass#setReferenceMustString(java.lang.String)
     */
    ...
    /* (nicht-Javadoc)
     * @see org.uic.ticket.api.spec.IPass#setProductOwnerMustString(java.lang.String)
     */
