...
public interface ICardReference {
     ...
     */
    public default String getCardIssuer() {
        CharSequence v = getCardIssuerInt();
        if (v == null) {
            return null;
        }
        return v.toString();
     ...
     * @return the card id
     */
    public default String getCardId() {
        CharSequence v = getCardIdInt();
        if (v == null) {
            return null;
        }
        return v.toString();
     ...
     */
    public default String getLeadingCardId() {
        CharSequence v = getLeadingCardIdInt();
        if (v == null) {
            return null;
        }
        return v.toString();
     ...
     */
    public default String getTrailingCardId() {
        CharSequence v = getTrailingCardIdInt();
        if (v == null) {
            return null;
        }
        return v.toString();
